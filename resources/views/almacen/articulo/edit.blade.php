	...
	{{Form::token()}}
		<div class="row">
			...
			<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
				...
				<input type="number" name="stock" class="form-control" required value="{{$articulo->stock}}">
				</div>
			</div>
		...
		<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
			<div class="form-group">
				...
				@if(($articulo->imagen)!="")
					<img src="{{asset('imagenes/articulos/'.$articulo->imagen)}}" alt="{{$articulo->nombre}}" max-height="300px" max-width="300px">
				@endif
			</div>
		</div>
		<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
